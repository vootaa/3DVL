...
function initStellarCore() {
  ...
  const chaoticPositions = new Float32Array(stars.length * 3)
  ...
  stars.forEach((star, index) => {
    ...
    chaoticPositions[i3] = Math.cos(chaosAngle) * chaosRadius
    chaoticPositions[i3 + 1] = chaosHeight
    chaoticPositions[i3 + 2] = Math.sin(chaosAngle) * chaosRadius

    positions[i3] = chaoticPositions[i3]
    positions[i3 + 1] = chaoticPositions[i3 + 1]
    positions[i3 + 2] = chaoticPositions[i3 + 2]
