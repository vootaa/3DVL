...
<template>
    <TresGroup :position="position" :rotation="rotation" :scale="[scale, scale, scale]" ref="probeGroup">
        <primitive :object="scene" />

        <TresPointLight ref="probeLight" color="#33ccff" :intensity="1.5" :distance="400" :decay="2"
            :position="[0, 5, 0]" />

        <TresPointLight color="#00ff88" :intensity="0.8" :distance="150" :position="[10, 5, 10]" />
    </TresGroup>
</template>